...
echo -e "${BLUE}🚀 一键启动MySQL版短链接服务${NC}"
...
echo ""
echo -e "${GREEN}🎉 MySQL版短链接服务部署完成！${NC}"
echo ""
echo -e "${BLUE}📋 服务信息:${NC}"
echo -e "  🌐 API地址: $BASE_URL"
echo -e "  🔑 API Token: $API_TOKEN"
echo -e "  🗄️  MySQL: localhost:3306 (shortlink/shortlink123456)"
echo -e "  🚀 Redis: localhost:6379"
echo ""
echo -e "${BLUE}🔧 管理命令:${NC}"
echo -e "  docker-compose -f docker-compose.mysql.yml logs -f    # 查看日志"
echo -e "  docker-compose -f docker-compose.mysql.yml restart    # 重启服务"
echo -e "  docker-compose -f docker-compose.mysql.yml down       # 停止服务"
echo ""
